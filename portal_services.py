...
function svcCard(s) {
  ...
  return '<article class="sl" data-svc="' + esc(s.id) + '" style="gap:0">'
    ...
    /* Pinned to the foot of the card: a longer description above must not
       push this button lower than its neighbour's. */
    + '<div class="sl-go" style="display:flex;gap:8px;flex-wrap:wrap;margin-top:auto;padding-top:12px">'
      + (bought
