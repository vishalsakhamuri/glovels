...
/* The cover: the picture the office chose for the post, printed once under the
   headline and again on its card on the index. Cropped to the same shape
   everywhere so a list of posts is a list, not a staircase. */
.prose .cover{margin:0 0 26px}
.prose .cover img{display:block;width:100%;aspect-ratio:16/9;object-fit:cover;
  border-radius:14px;border:1px solid var(--line);background:#f2f5f9}
.postcard .thumb{display:block;width:100%;aspect-ratio:16/9;object-fit:cover;
  border-radius:10px;border:1px solid var(--line);background:#f2f5f9;margin:0 0 12px}
